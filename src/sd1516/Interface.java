...
public class Interface {
  ...
  public void signIn() throws IOException {
    ...
    if (br.readLine().equals("KO"))
      System.out.println("Houve um erro a registá-lo como cliente, por favor tente novamente.");
  }
  ...
  public void pedidoCliente(String s1, String s2) {
    ...
    try {
      ...
      System.out.println("Irá demorar: " + (calcularTemp(xp, yp, x, y)) + " minutos a chegar a si"); // calcula
                                                                                                     // tempo
                                                                                                     // entre
                                                                                                     // posicao
                                                                                                     // do
      ...
      System.out.println("Irá demorar: " + (calcularTemp(xp, yp, xc, yc))
          + " minutos a chegar ao destino"); // calcula tempo entre posicao do taxi e do cliente
      resposta = br.readLine();
